...
import 'package:ombudsman/admin/view/data_laporan/verifikasi.dart';

class DataLaporan extends StatefulWidget {
  @override
  _DataLaporanState createState() => _DataLaporanState();
}
    ...
    return Scaffold(
      ...
      body: Container(
          child: StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection('Laporan').snapshots(),
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              ...
                                              content: Text(
                                                  'Apa kamu ingin menghapus Laporan dari ${laporan['Nama Lengkap']}?'),
                                              actions: <Widget>[
                                                FlatButton(
                                                  child: Text('Tidak'),
                                                  onPressed: () {
