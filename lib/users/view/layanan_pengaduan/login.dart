...
import 'package:ombudsman/admin/view/dashboard_admin.dart';
...
class _LoginState extends State<Login> {
  ...
  void login() async {
    if (_formKey.currentState.validate()) {
      ...
      if (result == null) {
        return null;
      } else if (user.uid == "cRiNG7jqw6RtooxFbjW1WlWPAsY2") {
        Firestore.instance.collection('Admin')
        .document(user.uid).get().then((value) => 
          Navigator.push(context, MaterialPageRoute(builder: (context) => 
            DashboardAdmin(
              uid: user.uid,
              namalengkap: value['Nama Lengkap'],
